...
export default defineConfig([
  globalIgnores(['dist']),
  {
    ...
    rules: {
      ...
      // version is for the spec author's reference, while the cast to
      // ``(...args: unknown[]) => unknown`` is what Bun actually invokes
      // — see web/src/__tests__/components/SchedulerPanel.modeWorkspace.test.tsx).
