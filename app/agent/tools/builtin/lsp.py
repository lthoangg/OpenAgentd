...
lsp_navigation = Tool(
    ...
    description=(
        ...
        "Workflow: Use grep for text search or glob for filename patterns when symbol locations are unknown. "
        "For unfamiliar source, start with document_symbol or workspace_symbol to locate symbols and line numbers; "
        "for a known identifier, use hover, go_to_definition, find_references, or find_implementations once exact line and character coordinates are known.\n"
