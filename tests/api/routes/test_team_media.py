...
Covers:
  GET /api/session/{session_id}/uploads/{filename}   → user uploads
  GET /api/session/{session_id}/media/{path:path}    → agent workspace
...
class TestUploadsEndpoint:
    def test_invalid_session_id_returns_400(self, client):
        resp = client.get("/api/session/not-a-uuid/uploads/file.png")
        assert resp.status_code == 400

    def test_missing_file_returns_404(self, client, session_id):
        resp = client.get(f"/api/session/{session_id}/uploads/does-not-exist.png")
    ...
    def test_filename_with_slash_does_not_reach_handler(self, client, session_id):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/sub%2Fevil.png")
    ...
    def test_filename_traversal_does_not_escape(self, client, session_id):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/..")
        assert resp.status_code in (200, 400, 404)
        if resp.status_code == 200:
            assert "text/html" in resp.headers.get("content-type", "")
    ...
    def test_happy_path_serves_file(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/hello.png")
    ...
    def test_backslash_in_filename_rejected(self, client, session_id):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/evil\\file.png")
        assert resp.status_code == 400
    ...
    def test_url_encoded_traversal_rejected(
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/%2e%2e%2fsecret.txt")
    ...
    def test_content_type_jpeg(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/photo.jpg")
        assert resp.status_code == 200
    ...
    def test_content_type_webp(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/image.webp")
        assert resp.status_code == 200
    ...
    def test_separation_invariant_uploads_cannot_serve_workspace(
        ...
        resp = client.get(f"/api/session/{session_id}/uploads/secret.txt")
        assert resp.status_code == 404
        assert "workspace secret" not in resp.text


# ── GET /api/session/{sid}/media/{path:path} ────────────────────────────────────


class TestWorkspaceMediaEndpoint:
    def test_invalid_session_id_returns_400(self, client):
        resp = client.get("/api/session/not-a-uuid/media/file.png")
        assert resp.status_code == 400

    def test_missing_file_returns_404(self, client, session_id):
        resp = client.get(f"/api/session/{session_id}/media/does-not-exist.png")
        assert resp.status_code == 404
    ...
    def test_traversal_rejected(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/..%2Fsecret.txt")
    ...
    def test_absolute_path_rejected(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media//etc/hosts")
    ...
    def test_nested_subpath_served(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/output/chart.png")
        assert resp.status_code == 200
        assert resp.headers["content-type"].startswith("image/png")
        assert resp.content == png
    ...
    def test_content_type_guessed_from_extension(
        ...
        resp = client.get(f"/api/session/{session_id}/media/notes.txt")
        assert resp.status_code == 200
    ...
    def test_directory_path_returns_404(
        ...
        resp = client.get(f"/api/session/{session_id}/media/subdir")
        assert resp.status_code == 404
    ...
    def test_empty_path_rejected(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/")
        assert resp.status_code in (400, 404)
    ...
    def test_whitespace_only_path_rejected(
        ...
        resp = client.get(f"/api/session/{session_id}/media/%20%20%20")
        assert resp.status_code == 400
    ...
    def test_windows_drive_letter_rejected(
        ...
        resp = client.get(f"/api/session/{session_id}/media/C:file.txt")
        assert resp.status_code == 400
    ...
    def test_deeply_nested_valid_path(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/a/b/c/d/e/file.txt")
        assert resp.status_code == 200
    ...
    def test_content_type_svg(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/diagram.svg")
        assert resp.status_code == 200
    ...
    def test_content_type_json(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/data.json")
        assert resp.status_code == 200
    ...
    def test_content_type_pdf(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/doc.pdf")
        assert resp.status_code == 200
    ...
    def test_symlink_to_file_inside_workspace_allowed(
        ...
        resp = client.get(f"/api/session/{session_id}/media/link.txt")
        assert resp.status_code == 200
    ...
    def test_symlink_escape_rejected(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/escape.txt")
        assert resp.status_code == 400
        assert "do not leak" not in resp.text
    ...
    def test_url_encoded_traversal_rejected(
        ...
        resp = client.get(f"/api/session/{session_id}/media/%2e%2e%2fsecret.txt")
        assert resp.status_code in (400, 404)
        assert "do not leak" not in resp.text
    ...
    def test_dot_slash_path_allowed(self, client, session_id, tmp_path, monkeypatch):
        ...
        resp = client.get(f"/api/session/{session_id}/media/./file.txt")
        assert resp.status_code == 200
