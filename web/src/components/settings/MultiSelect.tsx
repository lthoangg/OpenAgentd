      ...
      <PopoverTrigger
        ...
        render={
          <div
            ...
            tabIndex={0}
            className={cn(
              'flex min-h-9 w-full cursor-text flex-wrap items-center gap-1 rounded-sm border border-(--color-border) bg-(--bg-input) px-1.5 py-1 text-xs text-(--color-text) transition-colors outline-none md:min-h-8',
              ...
              return (
                <li key={o.value}>
                  <button
                    ...
                    className={cn(
                      'flex min-h-9 w-full cursor-pointer items-start gap-2 rounded-xs px-2 py-1.5 text-left transition-colors md:min-h-0',
