      ...
      {open && (
        <>
          ...
          <motion.aside
            ...
            className="mobile-viewport fixed inset-x-0 bottom-0 top-[calc(var(--spacing-app-header)+env(safe-area-inset-top,0px))] z-50 flex flex-col overflow-hidden border border-(--color-border) bg-(--bg-page) shadow-2xl sm:inset-auto sm:left-1/2 sm:top-1/2 sm:h-[min(80vh,640px)] sm:w-[min(90vw,800px)] sm:-translate-x-1/2 sm:-translate-y-1/2 sm:rounded-md"
            role="dialog"
            aria-modal="true"
